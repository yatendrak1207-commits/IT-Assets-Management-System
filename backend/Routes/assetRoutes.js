    ...
    async function (req, res) { 
        ...
        try { 
            ...
            const assets = await Asset.find({ 
                ...
                .populate( 
                    "supplier", 
                    "supplierId supplierName companyName companyContactNumber companyEmail companyAddress supplierStatus" 
                ); 
    ...
    async function (req, res) { 
        ...
        try { 
            ...
            if (supplier) { 
                ...
                selectedSupplier = await Supplier.findById(supplier); 
    ...
    async function (req, res) { 
        ...
        try { 
            ...
            if (supplier) { 
                ...
                newSupplier = await Supplier.findById( 
                    supplier 
                ); 
